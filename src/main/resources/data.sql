...
insert into T_SELLER(NAME, LAST_NAME, DOCUMENT, PHONE) VALUES ('Juan','Azul','89456123','156987456');
insert into T_SELLER(NAME, LAST_NAME, DOCUMENT, PHONE) VALUES ('Carlos','Fraga','18564237','15852963741');
insert into T_SELLER(NAME, LAST_NAME, DOCUMENT, PHONE) VALUES ('Diana','Gales','72346917','156987456');
insert into T_SELLER(NAME, LAST_NAME, DOCUMENT, PHONE) VALUES ('Andres','Blanco','20630679','15034957803');
# TODO: Insert Data to T_PRODUCT
insert into T_PRODUCT(NAME, DESCRIPTION, VALUE, QUANTITY) VALUES ('Jorgito','Alfajor','200','100');
insert into T_PRODUCT(NAME, DESCRIPTION, VALUE, QUANTITY) VALUES ('Cramer','Alfajor','100','50');
insert into T_PRODUCT(NAME, DESCRIPTION, VALUE, QUANTITY) VALUES ('Ricardito','Alfajor','300','20');
insert into T_PRODUCT(NAME, DESCRIPTION, VALUE, QUANTITY) VALUES ('El Sabroson','Alfajor','100','30');
