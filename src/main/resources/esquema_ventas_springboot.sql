...
--
-- Host: localhost    Database: ventas_springboot
-- ------------------------------------------------------
...
VALUES (1, '123', 500, 'Ejemplo de producto', 10);
/*!40000 ALTER TABLE `producto`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `producto_vendido`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `producto_vendido`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-03-25 18:09:24
